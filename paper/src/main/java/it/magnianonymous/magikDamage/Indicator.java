...
import it.magnianonymous.magikDamage.configuration.serializer.FilterSerializer;
import it.magnianonymous.magikDamage.configuration.serializer.HexSerializer;
...
public class Indicator {
    ...
    @SerializeWith(serializer = FilterSerializer.class)
